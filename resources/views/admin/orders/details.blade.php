                ...
                <table class ="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                @if($order->status)
                                    <span class="label label-success">Confirmed</sapn>
                                @else
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="header">
                    ...
                    <p class="category">product's details</p>
                </div>
                <div class="content table-responsive table-full-width">
                    <table class="table table-striped">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('uploads/', $order->products[0]->image) }}" target="_blank">
                                        <img src="{{ url('uploads/', $order->products[0]->image) }}" alt="{{ $order->products[0]->image }}" class="img-thumbnail" style="width: 100px">
                                    </a>
                                </td>
                            </tr>
                        </thead>
...
<a href="{{ url('/admin/orders') }}" class="btn btn-success"> Back to orders page</a>
@endsection